			...
			if msg["type"]=="Text" and not msg.get("message_id") in answered:
				if not sleeped:
					if hasInsult(msg.get("text"))[0] and not msg.get("author_object_guid") in admins :
						...
						bot.sendMessage(target, " @TOCREATE ", message_id=msg.get("message_id"))
						...
						bot.sendMessage(target, "لیست تبادلات فعال اکانت هوشمند :  ", message_id=msg.get("message_id"))
